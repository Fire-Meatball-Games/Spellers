...
namespace SpellSystem
{
    ...
    public class SpellDeck
    {
        ...
        {
            int lvlLimit = UnityEngine.Random.Range(1, maxLvl + 1);
            int lvl = UnityEngine.Random.Range(1, lvlLimit + 1);
        ...
        public List<SpellUnit> GetSpellPool(int size, int maxLvl = 3)
        {
            ...
            foreach (var spell in spellpool)
            {
                int lvlLimit = UnityEngine.Random.Range(1, maxLvl + 1);
                int lvl = UnityEngine.Random.Range(1, lvlLimit + 1);
                spellUnits.Add(new SpellUnit(spell, lvl));
            }
            return spellUnits;
        }
